...
class lessc {
	...
	protected function newFormatter() {
		$className = "JchOptimize\lessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "JchOptimize\lessc_formatter_$this->formatterName";
		}
...
class lessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('JchOptimize\lessc', 'preg_quote'),
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("JchOptimize\lessc", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("JchOptimize\lessc", "preg_quote"), $stop);
